...
interface AddFoodModalProps {
  ...
  onSetShowFoodCamera?: (show: boolean) => void; // Made optional - Camera disabled for App Store compliance
              ...
              <View style={styles.inputMethodSection}>
                ...
                <View style={styles.inputMethodButtons}>
                  ...
                  >
                    ...
                    <Text style={styles.inputMethodDisclaimer}>*Experimental Feature</Text>
                  </TouchableOpacity>
                  */}
                </View>
