...
import { parseLocalDate, formatDateToString, getDaysInMonth, getFirstDayOfMonth } from '../utils/dateUtils';
...
export const CalendarPicker: React.FC<CalendarPickerProps> = ({
  ...
  // Update current month when selectedDate changes or modal opens
  useEffect(() => {
    if (visible) {
      const date = parseLocalDate(selectedDate);
