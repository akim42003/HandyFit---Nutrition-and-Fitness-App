  ...
  useEffect(() => {
    ...
    if (visible && Platform.OS !== 'web') {
      ...
      foodRecognitionService.loadModel()
        .then((loaded) => {
          if (!loaded) {
            setModelError('Camera recognition requires app to be built and run on a physical device');
          }
        })
        .catch(error => {
            ...
            <View style={styles.overlay}>
              <View style={styles.header}>
                ...
                <View style={styles.headerTitleContainer}>
                  ...
                  <Text style={styles.disclaimerLabel}>Experimental</Text>
                </View>
                <View style={{ width: 40 }} />
              </View>
              ...
              <View style={styles.resultOverlay}>
                <View style={styles.resultCard}>
                  ...
                  <View style={styles.nutritionEstimate}>
                    <Text style={styles.nutritionTitle}>⚠️ Experimental Feature Notice</Text>
                    <Text style={styles.disclaimerText}>
                      This feature uses AI to identify food items. Results may vary.
                    </Text>
                    <Text style={styles.disclaimerText}>
                      Nutritional values are estimates only and should not be relied upon for medical purposes.
                    </Text>
                    <Text style={styles.disclaimerText}>
                      For accurate nutrition tracking, please use manual entry.
                    </Text>
                  </View>
